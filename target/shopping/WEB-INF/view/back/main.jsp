    ...
    <script type="text/javascript">
        $(function(){
            ...
            $("#user-set").click(function() {
                $("#frame-id1").attr("src", "userManager.html");
            });
            $("#product-set").click(function() {
                $("#frame-id1").attr("src", "${pageContext.request.contextPath}/back/showProductManager");
            });
            $("#product-type-set").click(function() {
                $("#frame-id1").attr("src", "${pageContext.request.contextPath}/back/showProductTypeManager");
            });
            $("#manager-set").click(function() {
                $("#frame-id1").attr("src", "staffManager.html");
            });
            $("#dept-set").click(function() {
                $("#frame-id1").attr("src", "deptManager.html");
            });
        });
    </script>
</head>
        ...
        <div class="container-flude flude-cc" id="a">
            <div class="row user-setting">
                <div class="col-xs-3 user-wrap">
                    <ul class="list-group">
                        <li  class="list-group-item active" name="productTypeSet" id="product-type-set">
                            <i class="glyphicon glyphicon-lock"></i> &nbsp;商品类型管理
                        </li>
                        <li class="list-group-item" name="productSet" id="product-set">
                ...
                <div class="col-xs-9" id="userPanel">
                    <iframe id="frame-id1"
                            src="${pageContext.request.contextPath}/back/showProductTypeManager"
